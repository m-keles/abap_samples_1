*&---------------------------------------------------------------------*
*& Report Z09_MK_MABI_09
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zmk_mc_part1_09_read_table.
...
*read TABLE gt_table into gs_structure INDEX 2.
READ TABLE gt_table INTO gs_structure WITH KEY id = 20220004 salary = 4000.
...
IF sy-subrc = 0.
  WRITE:  / gs_structure-id,
        ...
        / gs_structure-e_mail.
ELSEIF sy-subrc = 4.
  MESSAGE 'Belirtilen ID ye uygun calisan yok' TYPE 'S' DISPLAY LIKE 'E'.
ENDIF.
